...
# Plot.
ggp <- ggplot(data=dfc, aes(x=Club, y=value, color=Country, fill=Country, alpha=Type)) + 
...
#Save Fig
getwd()
setwd("C:/DataAnalysis/FootballCapacity")

ggsave("FootballCapacity.png", ggp, width=14, height=10, units="in")
